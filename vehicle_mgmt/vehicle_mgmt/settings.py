"""
Django settings for vehicle_mgmt project.
...
ROOT_URLCONF = 'vehicle_mgmt.urls'
...
WSGI_APPLICATION = 'vehicle_mgmt.wsgi.application'
...
EMAIL_HOST_PASSWORD = "ncle hyqe ghnd jyyn"  # use App Password, not your Gmail password
